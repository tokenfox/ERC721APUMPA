...
// ERC721A with Pumpametti VIP Mint
...
contract ERC721APUMPA is IERC721A, IERC721ALockedReserve {
    ...
    constructor(
        ...
        uint256 lockedReserveSize_,
        address lockedReserveContract_
    ) {
        _name = name_;
        _symbol = symbol_;
        _currentIndex = _startTokenId();
        _lockedReserveSize = lockedReserveSize_;
        _lockedReserveContract = IERC721OwnerCheck(lockedReserveContract_);

        // Pre-mint all reserve tokens into this contract
        if(_lockedReserveSize > 0) {
            _mintERC2309(address(this), _lockedReserveSize);
        }
    }
